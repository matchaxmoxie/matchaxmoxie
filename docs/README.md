...
If someone has to guess, the handoff is not clean yet. Same rule as the peanut-butter sandwich and the [FASE handoff manifesto](https://matchaxmoxie.github.io/matchaxmoxie/fase-map.html#handoff-heading).
...
- [FASE MAP ops](https://matchaxmoxie.github.io/matchaxmoxie/fase-map.html) · coordinator dashboard
