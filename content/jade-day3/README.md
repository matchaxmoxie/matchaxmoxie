# (Jade) Day 3 - FASE Events & Attendance

Coordinator drafts for Jade Zhao (module owner). **Do not paste full policy prose on public GitHub Pages.** Edit here; publish to Canvas when ready.

**Production checklist (public):** [`site/jade-day3.html`](../../site/jade-day3.html)
...
| Canvas page | Draft | Status |
|-------------|-------|--------|
| FASE Office Hours | [office-hours.md](office-hours.md) | draft |
| How to Check-in with the iPads **Video** | [ipad-checkin.md](ipad-checkin.md) | video needed |
...
(Divya) Day 1 - Overview, Day 1 - Working with Protégés, (Princesse U) Day 2 - Communication, (Caroline) Day 2 - Hours/Scheduling, (Rafael) Day 2 - AdRx & SAS
