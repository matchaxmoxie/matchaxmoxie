...
\pagestyle{fancy}
\fancyhf{}
\rhead{\small\textcolor{matcha}{archives ... matcha moxie}}
...
\begin{titlepage}
  ...
  {\large\color{moxie} ... matcha \& moxie ...}\\[2em]
  ...
  {\small\color{gray} \texttt{jadexzhao.github.io/jadexzhao/how-i-work.html}}\\[0.5em]
...
My specific focus is \textbf{HCI/D} ... Human-Computer Interaction and Design ... the study of how people interact with technology and how to design systems that are user-friendly, efficient, and genuinely useful. Not just building the thing. Understanding the person who uses it.

\subsection{the pb sandwich philosophy}

Computers execute literally. No assumed context. No reading between the lines. Every system, every design, every prompt has to be built with the assumption that nothing will be inferred ... that clarity is the whole job.
...
\begin{enumerate}[leftmargin=*, label=\arabic*.]
  \item \textbf{Value Execution} ... Goals and the five whys behind each one.
  \item \textbf{Control Failure Exposure} ... Separate identity from outcome. Learn to fail in low-stakes environments.
  \item \textbf{Relationship Inventory} ... Energy givers and energy takers. Gain clarity on which to deploy.
  \item \textbf{Deep Work Capacity} ... 30 minutes of undistracted work daily, gradually increased by 15\% until you can sustain 2--4 hours.
  \item \textbf{Daily Discomfort} ... Do one uncomfortable thing.
  \item \textbf{Learning Agility} ... Adapt to change and new conditions.
  \item \textbf{Skill Sprint} ... 30 days to one new skill: coding, public speaking, or financial modeling.
\end{enumerate}
...
\begin{enumerate}[leftmargin=*, label=\arabic*.]
  ...
  \item If you want to be treated as valuable, treat yourself as valuable ... your time, your work, your energy.
...
\begin{jadequote}
Sex doesn't make him stay. A pretty face doesn't make him stay. Loving him harder isn't going to make him stay either. Do you know what makes him stay? Himself. He will stay loyal and faithful to you only if he wants to be. You can't force someone to communicate. You can't beg someone to see that you are worth fighting for. ... Alissa DeRogatis
\end{jadequote}
...
\textit{Not ``coping'' or ``dealing'' ... navigating. There's a difference.}
...
\begin{jadequote}
Don't believe everything you see online. Go to an advisor, a trusted adult, or a therapist ... someone older with an outside perspective. You don't have to navigate it alone.
\end{jadequote}
...
The PB sandwich philosophy was always there before it had a name ... in the way I explained informatics to people who'd never heard of it, in the way I designed things with the assumption that the person on the other end needed clarity, not cleverness.
...
\begin{itemize}
  ...
  \item \textbf{Commitment to D\&I:} Deeply aware of the glass and bamboo ceilings in tech.
\end{itemize}
...
On duck syndrome and imposter syndrome: the solution wasn't self-reliance. It was community. Finding people who saw something in me that I didn't yet see in myself. Confidence isn't innate ... it's built through action, practice, and the people who believe in you while you're still figuring it out.

\subsection{notes on being a young woman in business}

\begin{jadequote}
Something no one talks about in the young entrepreneur space as a female is how often you're hit on under the guise of mentorship. Guys will frame it as networking. As career advice. As ``just trying to help.'' And when they have leverage ... age, connections, status ... it's even harder to trust your gut.
...
Which is exactly why I've been so adamant about creating my own networking collective ... one built on safety, clarity, and community. Spaces where people actually want to learn, not just leverage. Where support doesn't come with strings attached.
\end{jadequote}
...
\begin{itemize}
  ...
  \item Digital transformation strategy ... the bridge between human need and technical execution
\end{itemize}
...
Nobody tells you that study abroad starts with three days of not knowing where to buy groceries. Nobody tells you about the particular silence of a Sunday in a city that isn't yours yet ... the way the streets empty out and you walk through them trying to look like you belong.

The butterfly effect of almost not going. There were a hundred reasons not to ... the cost, the timing, the familiar shape of the life already built at IU. And then you went anyway. And the person who came back is not exactly the person who left. She's steadier. Less afraid of being alone with herself.
...
\begin{itemize}
  ...
  \item The person you became in the in-between hours ... the ones that don't get documented
\end{itemize}
...
not in a loud way. not in the way you used to imagine it ... some big arrival moment where everything clicked and you finally felt like the person you'd been performing. it wasn't like that.

it was quieter.

it was waking up in madrid and realizing you weren't waiting for something to happen anymore. it was finishing a semester you almost didn't go on. it was sitting with yourself in a country where no one knew you yet and finding out you didn't need them to. it was watching the two things you manifested fifty times not happen ... and discovering that the year without them was better than the years spent chasing them.
...
\begin{itemize}
  ...
  \item your standards ... even when they cost you something
...
\begin{itemize}
  ...
  \item the detour ... straight into industry instead, and it turned out to be the faster road
\end{itemize}
...
you're going to build things that are beautiful and useful and yours. you're going to find your people ... the ones who stay, the ones who match your energy, the ones who don't make you feel like a lot. you're going to learn that the right love is quiet and steady and doesn't require you to shrink.
...
i don't have everything figured out. the right person is still ahead. there are still days when i feel like too much. but i kept showing up ... for my goals, for my clients, for the jade plant, for myself. even when it was hard. especially when it was hard.
...
\begin{center}
  ...
  {\small\color{gray} ... end of archives ...}
\end{center}
